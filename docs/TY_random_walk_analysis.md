...
The TY market shows deviations from the random walk hypothesis, but the strength and direction of these deviations vary across time scales. Mean-reversion is more evident at intermediate horizons, while longer horizons show mixed signals. These findings motivate further strategy testing, with careful consideration of time-scale effects.
